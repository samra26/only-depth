    ...
    def test(self):
        ...
        for i, data_batch in enumerate(self.test_loader):
            ...
            with torch.no_grad():
                ...
                preds,sal_low,sal_med,sal_high,coarse_sal_rgb,coarse_sal_depth,Att,e_rgbd0,e_rgbd1,e_rgbd2 = self.net(depth,depth)
    ...
    def train(self):
        ...
        for epoch in range(self.config.epoch):
            ...
            for i, data_batch in enumerate(self.train_loader):
                ...
                sal_final,sal_low,sal_med,sal_high,coarse_sal_rgb,coarse_sal_depth,Att,sal_edge_rgbd0,sal_edge_rgbd1,sal_edge_rgbd2 = self.net(sal_depth,sal_depth)
